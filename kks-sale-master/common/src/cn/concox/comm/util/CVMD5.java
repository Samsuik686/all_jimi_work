...
public class CVMD5 {
	...
	public String getMD5ofBytes32(byte[] inbuf) {
		md5Init();
	...
	public String getMD5ofBytes16(byte[] inbuf) {
		md5Init();
		md5Update(inbuf, inbuf.length);
		md5Final();
		StringBuilder sb=new StringBuilder(16);
	...
	public static void main(String args[]) {
		String source = "实得分是是散发的父亲违法的发生的发生的发生的发生地方阿萨德法师的发改委噶何日个体户让他如何认识的发给我惹事耳而过色弱该死的分割肉公司的打发士大夫是打发士大夫阿萨德飞阿萨德飞阿萨德飞撒地方阿萨德飞阿萨德飞阿萨德飞阿萨德飞阿萨德飞阿萨德飞撒地方阿萨德飞阿斯顿飞";
		CVMD5 md5=new CVMD5();
		System.out.println(System.currentTimeMillis());
		System.out.println(md5.getMD5ofStr16(source));
		System.out.println(md5.getMD5ofBytes32(source.getBytes()));
		System.out.println(md5.getMD5ofBytes16(source.getBytes()));
		System.out.println(System.currentTimeMillis());
