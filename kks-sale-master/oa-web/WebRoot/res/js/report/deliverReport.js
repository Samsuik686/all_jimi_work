...
function queryDeliverList(pageNumber){
	currentPageNum=pageNumber;
	if(currentPageNum=="" || currentPageNum==null){
		currentPageNum=1;
	}
	var url=ctx+"/reportCon/getDeliverList";
	var param= null;
	if(!$('#dateTime').val()){
		getCurrentMonth();
	}
...
function exportReportExcel(){
	...
	var dateTime = $("#dateTime").val();
	if(dateTime !=""){
		ExportExcelDatas("reportCon/deliverExport?dateTime=" + dateTime +
