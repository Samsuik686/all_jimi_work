...
function dbClickChoosePJL(index, value) {
	...
	if (Falg) {
		$("#selected-type-box-PJL").append("<span class='tag'>" + value.proName + "<input type='hidden' name='win_PJLId' value=" + value.pjlId + "><input type='hidden' name='win_PJLname' value=" + value.proName + "><button class='panel-tool-close'></button></span>");
 ...
 */
function pjlSave() {
	$.messager.alert("操作提示", "2222222222222222222222", "info");
	sysSelectDatasPJL();
