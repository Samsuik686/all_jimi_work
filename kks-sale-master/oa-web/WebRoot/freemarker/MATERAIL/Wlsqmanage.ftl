   ...
   <Table ss:ExpandedColumnCount="${cosLenth}" ss:ExpandedRowCount="${size}" x:FullColumns="1" x:FullRows="1" ss:DefaultColumnWidth="80" ss:DefaultRowHeight="13.5">
		...
		<Row ss:StyleID="s50" ss:Height="44">
			<Cell ss:StyleID="s56" ss:MergeAcross="11">
				<Data ss:Type="String">物料申请管理列表</Data>
			</Cell>
		</Row>
	   ...
	   <#list peList as entity>
		  <Row ss:AutoFitHeight="0" ss:Height="24"> 
		    ...
		    <#if entity.matType??>																	<#-- === 物料类型（0：配件料 1：电子料）==== -->
				<#if entity.matType==0 >
					<Cell ss:StyleID="s54"><Data ss:Type="String">配件料</Data></Cell>
				<#elseif entity.matType==1>
		    ...
		    <Cell ss:StyleID="s54"><Data ss:Type="String">${(entity.unit)!''}</Data></Cell>				<#-- === 单位   ==== -->
		   	...
		   	<Cell ss:StyleID="s54"><Data ss:Type="String">${(entity.purpose)!''}</Data></Cell>		<#-- === 申请用途==== -->
			<#if entity.state??>																	<#-- === 批复（0：同意 1：不同意）==== -->
				<#if entity.state==0 >
					<Cell ss:StyleID="s54"><Data ss:Type="String">同意</Data></Cell>
				<#else>
