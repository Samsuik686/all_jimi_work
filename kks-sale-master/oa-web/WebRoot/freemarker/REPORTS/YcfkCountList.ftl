   ...
   <Table ss:ExpandedColumnCount="${cosLenth}" ss:ExpandedRowCount="${size}"
		...
		<Row ss:StyleID="s50" ss:Height="44">
			<Cell ss:StyleID="s56" ss:MergeAcross="10">
				<Data ss:Type="String">异常反馈分类统计报表</Data>
			</Cell>
		</Row>
	   ...
	   <#list peList as entity>
		   <Row ss:AutoFitHeight="0" ss:Height="24"> 
		    	...
		    	<Cell ss:StyleID="s54"><Data ss:Type="String">${(entity.measures)?replace('<span>','')?replace('</span>','')?replace('<br>','')?html}</Data></Cell>     <#-- === 处理方法==== -->
		    	<Cell ss:StyleID="s54"><Data ss:Type="String">${(entity.ynumber)!''}</Data></Cell>			<#-- === 数量    ==== -->
