...
<Workbook xmlns="urn:schemas-microsoft-com:office:spreadsheet"
 ...
 <Worksheet ss:Name="试流料${matName}返修明细报表${dispalyDate}">
  <Table ss:ExpandedColumnCount="${cosLenth}" ss:ExpandedRowCount="${size}" x:FullColumns="1" x:FullRows="1" ss:DefaultColumnWidth="80" ss:DefaultRowHeight="13.5">
   ...
   <Row ss:StyleID="s50" ss:Height="44">
		<Cell ss:StyleID="s56" ss:MergeAcross="10">
			<Data ss:Type="String">试流料${matName}返修明细报表${dispalyDate}</Data>
		</Cell>
   </Row>
   ...
   <#list peList as entity>
	   <Row ss:AutoFitHeight="0" ss:Height="24"> 
	    	...
	    	<#if entity.testMatfalg??>																	<#-- === 试流料  ==== -->
		     	<#if entity.testMatfalg==0>									  	                    
				    <Cell ss:StyleID="s54"><Data ss:Type="String">正常</Data></Cell>      
				<#else>
				    <Cell ss:StyleID="s54"><Data ss:Type="String">异常</Data></Cell>     
			    </#if>
			<#else>
				<Cell ss:StyleID="s54"><Data ss:Type="String"></Data></Cell> 
			</#if>
	    	<Cell ss:StyleID="s54"><Data ss:Type="String">${(entity.engineer)!''}</Data></Cell>	  		<#-- === 维修员   ==== -->
	    	<Cell ss:StyleID="s54"><Data ss:Type="String">${(entity.zzgzDesc)!''}</Data></Cell>	  	    <#-- === 最终故障==== -->
