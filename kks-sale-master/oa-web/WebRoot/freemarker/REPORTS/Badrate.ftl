...
<Workbook xmlns="urn:schemas-microsoft-com:office:spreadsheet"
 ...
 <Worksheet ss:Name="${isWarry}机器不良率报表">
   <Table ss:ExpandedColumnCount="${cosLenth}" ss:ExpandedRowCount="${size}"
		...
		<Row ss:StyleID="s50" ss:Height="44">
			<Cell ss:StyleID="s56" ss:MergeAcross="3">
				<Data ss:Type="String">${isWarry}机器不良率报表</Data>
			</Cell>
		</Row>
	   ...
	   <#list peList as entity>
		   <Row ss:AutoFitHeight="0" ss:Height="24"> 
		    	...
		    	<Cell ss:StyleID="s54"><Data ss:Type="String">${(entity.repairs)!''}</Data></Cell>   			<#-- === 返修机数量 ==== -->
		    	<Cell ss:StyleID="s54"><Data ss:Type="String">${(entity.goods)!''}</Data></Cell>			<#-- === 出货总数    ==== -->
		    	<Cell ss:StyleID="s54"><Data ss:Type="String">${(entity.percent)!''}</Data></Cell>	  			<#-- === 总返修比率    ==== -->		    	
		   </Row>
	    </#list>
