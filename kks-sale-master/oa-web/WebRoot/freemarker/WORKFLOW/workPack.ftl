   ...
   <Table ss:ExpandedColumnCount="${cosLenth}" ss:ExpandedRowCount="${size}" x:FullColumns="1" x:FullRows="1" ss:DefaultColumnWidth="80" ss:DefaultRowHeight="13.5">
	   ...
	   <#list peList as entity>
		   <Row ss:AutoFitHeight="0" ss:Height="24"> 
	    	...
	    	<Cell ss:StyleID="s54"><Data ss:Type="String">${(entity.w_phone)!''}</Data></Cell>   	<#-- === 手机号 ==== -->
	    	<Cell ss:StyleID="s54"><Data ss:Type="String">${(entity.w_telephone)!''}</Data></Cell>   	<#-- === 座机号 ==== -->
	    	<Cell ss:StyleID="s54"><Data ss:Type="String">${(entity.w_address)!''}</Data></Cell> 	<#-- === 地址 ==== -->
		  </Row>
	   </#list>
 </Table>
