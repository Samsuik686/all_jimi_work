   ...
   <Table ss:ExpandedColumnCount="${cosLenth}" ss:ExpandedRowCount="${size}" x:FullColumns="1" x:FullRows="1" ss:DefaultColumnWidth="80" ss:DefaultRowHeight="13.5">
		...
		<Row ss:StyleID="s50" ss:Height="44">
			<Cell ss:StyleID="s56" ss:MergeAcross="4">
				<Data ss:Type="String">随机附件管理列表</Data>
			</Cell>
		</Row>
	   ...
	   <#list peList as entity>
		   <Row ss:AutoFitHeight="0" ss:Height="24"> 
		    	<Cell ss:StyleID="s54"><Data ss:Type="String">${(entity.category)!''}</Data></Cell>  <#-- === 类别  ==== -->
		    	<Cell ss:StyleID="s54"><Data ss:Type="String">${(entity.brand)!''}</Data></Cell>	  		<#-- === 品牌   ==== -->
		    	<Cell ss:StyleID="s54"><Data ss:Type="String">${(entity.name)!''}</Data></Cell>	  	    <#-- === 名称  ==== -->
		    	<Cell ss:StyleID="s54"><Data ss:Type="String">${(entity.color)!''}</Data></Cell>       	<#-- === 颜色   ==== -->
