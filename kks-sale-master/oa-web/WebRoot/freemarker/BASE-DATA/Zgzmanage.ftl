 ...
 <Worksheet ss:Name="最终故障管理列表">
   <Table ss:ExpandedColumnCount="${cosLenth}" ss:ExpandedRowCount="${size}" x:FullColumns="1" x:FullRows="1" ss:DefaultColumnWidth="80" ss:DefaultRowHeight="13.5">
		...
		<Row ss:StyleID="s50" ss:Height="44">
			<Cell ss:StyleID="s56" ss:MergeAcross="6">
				<Data ss:Type="String">最终故障管理列表</Data>
			</Cell>
		</Row>
	   ...
	   <#list peList as entity>
		   <Row ss:AutoFitHeight="0" ss:Height="24">
		    	<Cell ss:StyleID="s54"><Data ss:Type="String">${(entity.faultType)!''}</Data></Cell>   <#-- === 故障类别   ==== -->
		    	<Cell ss:StyleID="s54"><Data ss:Type="String">${(entity.proceMethod)!''}</Data></Cell>	  <#-- === 最终故障   ==== -->
		    	<Cell ss:StyleID="s54"><Data ss:Type="String">${(entity.methodNO)!''}</Data></Cell>	  	  <#-- === 故障编码   ==== -->
				<Cell ss:StyleID="s54"><Data ss:Type="String">${(entity.modelType)!''}</Data></Cell> 	<#-- ===  型号类别  ==== -->
		    	<Cell ss:StyleID="s54"><Data ss:Type="String">${(entity.remark)!''}</Data></Cell>       <#-- === 方法描述   ==== -->
			    <#if entity.isSyncSolution??>
			 	    <#if entity.isSyncSolution==1>										  	  				  <#-- === 是否同步 ==== -->
