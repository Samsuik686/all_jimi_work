   ...
   <Table ss:ExpandedColumnCount="${cosLenth}" ss:ExpandedRowCount="${size}" x:FullColumns="1" x:FullRows="1" ss:DefaultColumnWidth="80" ss:DefaultRowHeight="13.5">
		...
		<Row ss:StyleID="s50" ss:Height="44">
			<Cell ss:StyleID="s56" ss:MergeAcross="9">
				<Data ss:Type="String">送修单位管理列表</Data>
			</Cell>
		</Row>
	   ...
	   <#list peList as entity>
		   <Row ss:AutoFitHeight="0" ss:Height="24"> 
		    	...
		    	<Cell ss:StyleID="s54"><Data ss:Type="String">${(entity.serviceTime)!''}</Data></Cell>	<#-- === 服务周期   ==== -->
		    	<Cell ss:StyleID="s54"><Data ss:Type="String">${(entity.linkman)!''}</Data></Cell>	  	<#-- === 联系人  ==== -->
		    	<Cell ss:StyleID="s54"><Data ss:Type="String">${(entity.phone)!''}</Data></Cell>       	<#-- === 手机号   ==== -->
		    	<Cell ss:StyleID="s54"><Data ss:Type="String">${(entity.telephone)!''}</Data></Cell>    <#-- === 座机号   ==== -->
				<Cell ss:StyleID="s54"><Data ss:Type="String">${(entity.email)!''}</Data></Cell>       	<#-- === 邮箱  ==== -->
				<Cell ss:StyleID="s54"><Data ss:Type="String">${(entity.fax)!''}</Data></Cell>       	<#-- === 传真==== -->
				<Cell ss:StyleID="s54"><Data ss:Type="String">${(entity.address)!''}</Data></Cell>       <#-- === 通信地址  ==== -->
