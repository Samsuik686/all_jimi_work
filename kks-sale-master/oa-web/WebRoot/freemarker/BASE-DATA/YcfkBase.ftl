   ...
   <Table ss:ExpandedColumnCount="${cosLenth}" ss:ExpandedRowCount="${size}" x:FullColumns="1" x:FullRows="1" ss:DefaultColumnWidth="80" ss:DefaultRowHeight="13.5">
		...
		<Row ss:StyleID="s50" ss:Height="44">
			<Cell ss:StyleID="s56" ss:MergeAcross="2">
				<Data ss:Type="String">异常反馈基础列表</Data>
			</Cell>
		</Row>
	   ...
	   <#list peList as entity>
		   <Row ss:AutoFitHeight="0" ss:Height="24"> 
		   	<th checkbox="true" field="yid"></th>
		    	<Cell ss:StyleID="s54"><Data ss:Type="String">${(entity.problems)!''}</Data></Cell>  	<#-- === 类别  ==== -->
		    	<Cell ss:StyleID="s54"><Data ss:Type="String">${(entity.proDetails)!''}</Data></Cell>	<#-- === 问题描述   ==== -->
		    	<Cell ss:StyleID="s54"><Data ss:Type="String">${(entity.methods)!''}</Data></Cell>	  	<#-- === 处理方法  ==== -->
		   </Row>
	    </#list>
 </Table>
