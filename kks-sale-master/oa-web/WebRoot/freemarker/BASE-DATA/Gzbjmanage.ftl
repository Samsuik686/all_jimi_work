   ...
   <Table ss:ExpandedColumnCount="${cosLenth}" ss:ExpandedRowCount="${size}" x:FullColumns="1" x:FullRows="1" ss:DefaultColumnWidth="80" ss:DefaultRowHeight="13.5">
		...
		<Row ss:StyleID="s50" ss:Height="44">
			<Cell ss:StyleID="s56" ss:MergeAcross="3">
				<Data ss:Type="String">故障报价管理列表</Data>
			</Cell>
		</Row>
	   ...
	   <#list peList as entity>
		   <Row ss:AutoFitHeight="0" ss:Height="24"> 
	    	...
	    	<Cell ss:StyleID="s54"><Data ss:Type="String">${(entity.faultDesc)!''}</Data></Cell>   				<#-- === 故障现象 ==== -->
	    	<#if entity.costs??>																				<#-- === 价格 （￥）  ==== -->
			    <Cell ss:StyleID="s54"><Data ss:Type="String">${(entity.costs)?string("#.##")}</Data></Cell> 		
		    <#else>  
