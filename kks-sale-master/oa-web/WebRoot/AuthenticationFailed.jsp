...
<html>
  <head>
    ...
    <title>OA Authentication Failed</title>
	...
	<style type="text/css">
			...
			body {
				 ...
				 width:100%;
			     height:100%;
			     background:url('${ctx}/res/image/authenticationFailed.jpg') no-repeat;
     ...
     <div class="pngfix">
	  <body >
			...
			<table border="0" cellpadding="0" cellspacing="0" >
				  <tr> <td ><h4 >错误代码：</h4></td><td><h1 style="color:#99FFFF">-2</h1></td></tr>
				  <tr> <td ><h4 >代码说明：</h4></td><td><h1 style="color:#99FFFF">您没有权限访问</h1></td></tr>
