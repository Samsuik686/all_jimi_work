...
<html>
<head>
<script type="text/javascript" src="${ctx}/res/js/basicdata/zgzmanage.js?20170220"></script>
<script type="text/javascript" src='${ctx }/res/script/windowReset.js'></script>
<script type="text/javascript" src="${ctx}/res/js/basicdata/basegroup.js"></script>
</head>
<body style="margin: 0">
	<input type="hidden" id="LX_Type" value="BASE_ZZGZ" />
	<input type="hidden" id="LX_Type1" value="BASE_ZBXH" />
	<input type="hidden" id="gIds" name="gId" />
	<div class="easyui-layout" style="overflow: hidden; width: 100%;" fit="true">
		<div region="west" id="dic-west" style="width: 200px;" title="最终故障类别">
		...
		<div region="center" id="dic-center" style="overflow: auto" title="最终故障管理列表">
			<div id="toolbar" style="padding: 10px 15px;">
				<div>
					...
					<table cellspacing="0" cellpadding="0">
						<tr>
							<td>
								<a href="javascript:;" class="easyui-linkbutton" iconCls="icon-addicon" plain="true" onclick="zzgz_addInfo();">增加</a>
							</td>
							<td>
								<div class="datagrid-btn-separator"></div>
							</td>
							<td>
								<a href="javascript:;" class="easyui-linkbutton" iconCls="icon-xgicon" plain="true" onclick="zzgz_updateInfo();">修改</a>
							</td>
							<td>
								<div class="datagrid-btn-separator"></div>
							</td>
							<td>
								<a href="javascript:;" class="easyui-linkbutton" iconCls="icon-delecticon" plain="true" onclick="zzgz_deleteInfo();">删除</a>
							</td>
							<td>
								<div class="datagrid-btn-separator"></div>
							</td>
			...
			<table id="DataGrid1" class="easyui-datagrid" singleSelect="true" rownumbers="false" pagination="true" fit="true" fitColumns="true" autoRowHeight="true" striped="true" pageSize="20" scrollbarSize="0" toolbar="#toolbar">
				<thead>
					<tr>
						...
						<th field="enabledFlag" width="220" align="center">是否禁用</th>
					</tr>
				</thead>
			</table>
		</div>
		<div style="position:fixed;">
			<!-- 添加-START-->
			<div id="zzgz_window" class="easyui-window" title="更新最终故障信息" modal="true" closed="true" maximizable="false" minimizable="false" collapsible="false" style="visibility:hidden; width: 500px; height: 400px; padding: 5px;">
				<div class="easyui-layout" fit="true">
						...
						<form id="mform" action="">
							<table align="center">
								...
								<tr>
									<td>故障类别：</td>
									<td align="left">
										<input id="type" class="easyui-combobox" editable="false" panelHeight="auto" data-options="valueField:'id',textField:'text'" style="width: 150px;" required="true" required="true" missingMessage="请选择类别" />
									</td>
								</tr>
								<tr>
									<td>最终故障：</td>
									<td>
										<input type="text" id="proceMethod" style="width: 220px" class="easyui-validatebox" required="true" missingMessage="请填写此字段" />
									</td>
								</tr>
								<tr>
									<td>故障编码：</td>
									<td>
										<input type="text" id="methodNO" style="width: 220px" class="easyui-validatebox" required="true" missingMessage="请填写此字段" />
									</td>
								</tr>
								<tr>
									<td>型号类别：</td>
									<td align="left">
										<input id="modelType" class="easyui-combobox" editable="false" panelHeight="auto" data-options="valueField:'id',textField:'text'" style="width: 150px;" />
									</td>
								</tr>
								<tr>
									<td>是否同步：</td>
									<td align="left">
										<input type="radio" name="isSyncSolution" value="1" checked="checked" />是 &nbsp; 
										<input type="radio" name="isSyncSolution" value="0" />否
									</td>
								</tr>
								<tr>
									<td>是否禁用：</td>
								...
								<tr>
									<td>方法描述：</td>
									<td>
										<textarea id="remark" style="width: 220px; height: 100px;" rows="1"></textarea>
									</td>
								</tr>
							</table>
						</form>
					...
					<div region="south" border="false" style="text-align: right; height: 30px; line-height: 30px;">
						<a id="tAdd" class="easyui-linkbutton" iconCls="icon-ok" href="javascript:void(0)" onclick="InfoSave()">保存</a> 
						<a id="tDelete" class="easyui-linkbutton" iconCls="icon-cancel" href="javascript:void(0)" onclick="zgzwindowClose()">关闭</a>
					</div>
				</div>
			</div>
			<!-- 添加-END-->
