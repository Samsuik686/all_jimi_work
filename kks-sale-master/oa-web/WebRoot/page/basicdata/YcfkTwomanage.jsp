...
<body style="margin: 0">
	...
	<div class="easyui-layout" style="overflow: hidden; width: 100%; height: 100%" fit="true">
		...
		<div region="center" id="dic-center" style="overflow: auto" title="异常反馈数据查询">
			<div id="toolbar" style=" padding: 10px 15px;">
				<div style="margin-bottom:2px">	
					...
					<span>
						所在工站:&nbsp;
						<select id="ycfk_currentSite_search" class="easyui-combobox form-search" style="width: 100px;" editable="false" panelHeight="auto" >
							<option value="" selected="selected">全部</option>
							<option value="客服">客服</option>
							<option value="终端技术">终端技术</option>
							<option value="平台技术">平台技术</option>
							<option value="品质部">品质部</option>
							<option value="产品规划部">产品规划部</option>
							<option value="维修">维修</option>
							<option value="项目部">项目部</option>
							<option value="几米">几米</option>
							<option value="市场">市场</option>
						</select>&nbsp;
					</span>
					<span>销售机型: <input type="text" class="form-search" id="model_search" style="width: 125px" /></span>&nbsp;
					<span>联系电话: <input type="text" class="form-search" id="phone" style="width: 135px" /></span>&nbsp;
				</div>
				<div style="margin-bottom:5px">	 
					...
					<span>跟进人: <input type="text" class="form-search" id="followupPeople_search" style="width: 135px" /></span>&nbsp;
					<span>责任人: <input type="text" class="form-search" id="recipient_search" style="width: 135px" /></span>&nbsp;
					<span>
						处理状态:&nbsp;
						<select id="ycfk_completionState" class="easyui-combobox form-search" style="width: 100px;" editable="false" panelHeight="auto" >
					...
					<span>客户姓名: <input type="text" class="form-search" id="customerName" style="width: 135px" /></span>&nbsp;
				...
				<div>
					<table cellspacing="0" cellpadding="0">
						<tr>							
							<td id="delBut">
								<a href="javascript:;" class="easyui-linkbutton" iconCls="icon-delecticon" plain="true" onclick="ycfkTwo_deleteInfo('admin');">删除</a>															
							</td>
							<td>
								<a href="javascript:;" class="easyui-linkbutton" iconCls="icon-daochuicon" plain="true" onclick="exportInfo();">导出</a>
								<div class="datagrid-btn-separator" id="divDelBut"></div>
							</td>
							<td>
			...
			<table id="DataGrid1" class="easyui-datagrid" singleSelect="true" sortable="true" rownumbers="false" pagination="true" fit="true" striped="true" pageSize="20" scrollbarSize="0" toolbar="#toolbar">
				<thead>
					<tr>
						...
						<th field="analysis" width="220" align="center">原因分析</th>
						...
						<form id="ycform" action="">
							<table align="center">
								...
								<tr>
									<td>&nbsp;设备IMEI：</td>
									<td colspan="3">
										<textarea  id="imeii"  rows="2" cols="76" class="easyui-validatebox" required="true" missingMessage="请填写此字段"></textarea>
									</td>									
								</tr>
								<tr>
									<td>&nbsp;配件数量：</td>
								...
								<tr>
									<td>&nbsp;备&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;注：</td>
									<td colspan="3">
										<textarea  id="remaki" rows="2" cols="76" ></textarea>
									</td>
								</tr>
								<tr>
									<td>&nbsp;问题描述：</td>
									<td colspan="3">
										<textarea  rows="2" cols="76"  id="descriptioni"  class="easyui-validatebox" required="true" missingMessage="请填写此字段"></textarea>
									</td>
								</tr>
								<tr>
									<td>&nbsp;原因分析：</td>
									<td colspan="3">
										<textarea  rows="2" cols="72"  id="analysis"  class="easyui-validatebox" required="true" missingMessage="请填写此字段"></textarea>
									</td>
								</tr>
								<tr>
									<td>&nbsp;附&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;件：</td>
								...
								<tr>
									<td>&nbsp;处理措施：</td>
									<td colspan="3">
										<textarea  id="measuresi" rows="2" cols="76"  class="easyui-validatebox" required="true" missingMessage="请填写此字段"></textarea>
									</td>
								</tr>
								<tr>
									<td>&nbsp;库存品处理策略：</td>
