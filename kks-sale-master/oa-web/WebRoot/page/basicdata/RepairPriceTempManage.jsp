...
<html>
<head>
<script type="text/javascript" src="${ctx}/res/js/basicdata/RepairPriceTempManage.js?20170118"></script>
<script type="text/javascript" src="${ctx}/res/js/basicdata/repairPrice/pjl.js"></script>
<script type="text/javascript" src="${ctx}/res/js/basicdata/repairPrice/gzbj.js"></script>
<script type="text/javascript" src="${ctx}/res/js/basicdata/repairPrice/priceGroupPj.js"></script>
...
#selected-type-box-GZBJ .panel-tool-close{
	display:inline;
} 
#selected-type-box-PGPJ .panel-tool-close{
	display:inline;
} 
</style>
</head>
<body style="margin: 0">
	...
	<div class="easyui-layout" style="overflow: hidden; width: 100%;" scroll="no" fit="true">
		...
		<div region="center" id="dic-center" style="overflow: auto" title="维修报价管理列表">
			...
			<table id="DataGrid1" class="easyui-datagrid" singleSelect="true" sortable="true" rownumbers="false" pagination="true" fit="true" striped="true" pageSize="20" scrollbarSize="0" toolbar="#toolbar">
				<thead>
					<tr>
						...
						<th field="repairType" width="150" align="center">报价类别</th>
						<th field="amount" width="280" align="center">报价描述</th>
						<th field="price" width="90" align="center">报价金额（￥）</th>
						...
						<th field="pjlPrice" width="90" align="center">配件料费（￥）</th>
						<th field="priceGroupDesc" width="260" align="center">报价配件料组合</th>
						<th field="pjlDesc" width="260" align="center">关联配件料</th>
						<th field="gzbjPrice" width="90" align="center">故障费（￥）</th>
						<th field="gzbjDesc" width="260" align="center">故障报价</th>
		...
		<div style="position:fixed;">
			<div id="updateWindow" class="easyui-window" title="更新维修报价信息" modal="true" closed="true" maximizable="false" minimizable="false" collapsible="false"  
				style="visibility:hidden; width: 520px; height: 400px; padding: 5px;">
				<div class="easyui-layout" fit="true">
					<div region="center" border="false" style="padding: 2px; background: #fff; border: 1px solid #ccc; overflow: hidden">
						<form id="rform" action="">
							<table align="center">
								...
								<tr>
									<td align="right" style="width: 80px;">类&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;别：</td>
									<td>
								...
								<tr>
									<td align="right" style="width: 80px;">编&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;码：</td>
									<td>
										<input type="text" id="priceNumber" style="width: 150px;" maxlength="255" class="easyui-validatebox"  required="true" missingMessage="请填写编码"/>
									</td>
									<td align="right" style="width: 60px;">主板型号：</td>
									<td>
										<input type="text" id="model" style="width: 135px;" maxlength="255" class="easyui-validatebox"/>
									</td>
								</tr>
								<tr>
									<td align="right" style="width: 80px;">关联配件料：</td>
									<td colspan="3" >
								...
								<tr>
									<td align="right" style="width: 80px;">配件料组合：</td>
									<td colspan="3">
								...
								<tr>
									<td align="right" style="width: 80px;">故障报价：</td>
									<td colspan="3">
								     	<input type="hidden" id="gzbjId">
										<input type="text" id="gzbjDesc" style="width: 300px;" readonly="readonly"/>
										<label><a href="javascript:void(0)" class="easyui-linkbutton" iconCls="icon-add" plain="true" onclick="doinsertGZBJ();">选择</a></label>
									</td>
								</tr>
								<tr>
									<td align="right" style="width: 80px;">配件料费：</td>
								    <td><input type="text" id="pjlPrice" style="width: 150px;" value="0" disabled="disabled"></td>
								    <td align="right" style="width: 60px;">故&nbsp;障&nbsp;费：</td>
								    <td><input type="text" id="gzbjPrice" style="width: 135px;" value="0" disabled="disabled"></td>
								</tr>
								<tr>
									<td align="right" style="width: 80px;">报价金额：</td>
									<td>
										<input type="text" id="price" style="width: 150px;" value="0" disabled="disabled"/>
									</td>
									<td align="right" style="width: 60px;">工&nbsp;时&nbsp;费：</td>
									<td>
										<input type="text" id="hourFee" style="width: 135px;" class="easyui-validatebox" validType="Amount"  required="true" missingMessage="请填写金额"/>
									</td>
								</tr>
								<tr>
									<td align="right" style="width: 80px;">启用状态：</td>
									<td align="left">
								...
								<tr>
									<td align="right" style="width: 80px;">报价描述：</td>
									<td colspan="3">
		    ...
		    <!-- 故障报价- Start-->
			<div id="gzbj_w" class="easyui-window" title="故障报价" modal="true" closed="true" maximizable="false" minimizable="false" collapsible="false" 
				 style="width:850px;height:520px; visibility: hidden; ">
				<div class="easyui-layout" fit="true">
					<div region="center" border="false" style="padding:10px;background:#fff;border:1px solid #ccc;" title="[详细信息]  注：双击选择">
						<div style="height:280px;">
							<div id="gzbjToolbar" style=" padding: 10px 15px;">
								<div style="margin-bottom:5px">	
									<div style="margin-bottom: 5px">
										<input type="hidden" id="defaultModel">
										<span>故障类别: <input type="text" class="form-search2" id="searchByFaultType" style="width: 135px" /> </span>&nbsp;&nbsp; 
										<a id="searchinfo" name="ckek" class="easyui-linkbutton" iconCls="icon-search" href="javascript:void(0)" onclick="queryListPageGZBJ();">查询</a>
									</div>
									<div>
					                    <table cellspacing="0" cellpadding="0">
											<tbody>
												<tr>
													<td><a href="javascript:;" class="easyui-linkbutton" iconCls="icon-reload" plain="true" onclick="queryListPageGZBJ();">刷新</a></td>							
												</tr>
										 	</tbody>
										</table>
									</div>
							...
							<table id="gzbj_DataGrid" fit="true" sortable="true" rownumbers="false" autoRowHeight="true" striped="true" fitColumns="true" pagination="true" toolbar="#gzbjToolbar">
								<thead>
									<tr>
										<th field="id" hidden="true"></th>
										<th field="faultType" width="150" align="center">故障类别</th>
										<th field="faultDesc" width="150" align="center">故障现象</th>
										<th field="costs" width="80" align="center">价格（￥）</th>
										<th field="remark" width="280" align="center">备注</th>
									</tr>
								</thead>
							</table>
						</div>
						<div class="selected-type" style="height: 130px;">
							<div class="panel-header"><a href="javascript:;" class="clear-select-btn">清除</a>已选故障报价</div>
							<div class="selected-type-box" id ="selected-type-box-GZBJ"> </div>						
						</div>
					</div>
					<div region="south" border="false" style="text-align:right;height:30px;line-height:30px;">
					<a class="easyui-linkbutton" iconCls="icon-ok" href="javascript:void(0)" onclick="gzbjSave()">保存</a>
						<a id="treeDelete" class="easyui-linkbutton" iconCls="icon-cancel" href="javascript:void(0)" onclick="closeGZBJ_w();">关闭</a>
				    </div>
				</div>
		    </div>
		    <!--故障报价  - End-->
