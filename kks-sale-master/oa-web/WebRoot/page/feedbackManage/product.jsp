...
<html>
<head>
<script type="text/javascript" src="${ctx}/res/js/feedbackManage/product.js?20170310"></script>
			...
			<table id="DataGrid1" class="easyui-datagrid" sortable="true" rownumbers="false" pagination="true" fit="true" striped="true" pageSize="20" scrollbarSize="0" toolbar="#toolbar">
				<thead>
					<tr>
						...
						<th field="severityFlag" width="280" align="center">库存品处理措施</th>
						<th field="completionState" width="80" align="center">状态</th>
						<th field="productCreateTime" width="130" align="center">设备到站时间</th>
						...
						<th field="productStatus" width="80" align="center">本工站状态</th>
