...
<html>
<head>
<script type="text/javascript" src="${ctx}/res/js/feedbackManage/terminalService.js?20170310"></script>
			...
			<div id="toolbar" style=" padding: 10px 15px;">
				...
				<div>
					<table cellspacing="0" cellpadding="0">
						<tr>
							<td>
								<a href="javascript:;" class="easyui-linkbutton" iconCls="icon-addicon" plain="true" onclick="ycfkTwo_addInfo();">增加</a>															
							</td>
							<td>
							...
							<td>
								<a href="javascript:;" class="easyui-linkbutton" iconCls="icon-delecticon" plain="true" onclick="ycfkTwo_deleteInfo();">删除</a>							
								<div class="datagrid-btn-separator"></div>
							</td>							
							<td>
			...
			<table id="DataGrid1" class="easyui-datagrid" sortable="true" rownumbers="false" pagination="true" fit="true" striped="true" pageSize="20" scrollbarSize="0" toolbar="#toolbar">
				<thead>
					<tr>
						...
						<th field="termailCreateTime" width="130" align="center">设备到站时间</th>
						...
						<th field="termailStatus" width="80" align="center">本工站状态</th>
						...
						<th field="strategy" width="280" align="center">库存品处理措施</th>
