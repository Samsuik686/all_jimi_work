...
<html>
<head>
<script type="text/javascript" src="${ctx}/res/js/feedbackManage/ycfkRepair.js?20170314"></script>
			...
			<table id="DataGrid1" class="easyui-datagrid" sortable="true" rownumbers="false" pagination="true" fit="true" striped="true" pageSize="20" scrollbarSize="0" toolbar="#toolbar">
				<thead>
					<tr>
						...
						<th field="severityFlag" width="280" align="center">问题严重程度</th>
						...
						<th field="repairStatus" width="80" align="center">本工站状态</th>
