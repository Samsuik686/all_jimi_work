...
<script type="text/javascript" src="${ctx}/res/js/report/collectFeesYearReport.js"></script>
<script type="text/javascript" src='${ctx}/res/script/windowReset.js'></script>
<script type="text/javascript" src="${ctx}/res/js/my97datepicker/WdatePicker.js"></script><base>
</head>
<body style="margin: 0">
	<div class="easyui-layout" fit="true">
		<div region="center" title="售后收费年报表">
			<div id="toolbar" style="padding:10px 15px;">
			   <div style="margin-bottom:5px">
				   <span>选择日期(年):&nbsp;<input type="text" class="form-search" id="searchDate" onfocus="WdatePicker({dateFmt:'yyyy',readOnly:true})" style="width: 110px"></span>
			...
			<table id="DataGrid1" class="easyui-datagrid" fit="true" singleSelect="true" sortable="true" rownumbers="false" fitColumns="true" striped="true" scrollbarSize="0"  toolbar="#toolbar">
				<thead>
					<tr>
						<th field="payMonth" width="220" align="center">月份</th>
						...
						<th field="totalPay" width="220" align="center">月汇总(￥)</th>
					</tr>
				</thead>
			</table>
		</div>
