...
<html>
<head>
<script type="text/javascript" src="${ctx}/res/js/report/receiveYearReport.js"></script>
		...
		<div region="center" title="收件年报表" >
			<div  id="toolbar" style="padding:10px 15px;">
			   <div style="margin-bottom:5px">
					...
					<a id="searchinfo" name="ckek" class="easyui-linkbutton" iconCls="icon-search" href="javascript:void(0)" onclick="queryReceiveYearList('')">查询</a>
			    </div>
			    <div>
			...
			<table id="Table_Accqute" class="easyui-datagrid"  fit="true" singleSelect="true" sortable="true" rownumbers="false" pagination="false" fitColumns="true"  striped="true" scrollbarSize="0"  toolbar="#toolbar">
				<thead>
					<tr>
						...
						<th field="totalNum" width="130" align="center">收件年统计</th>
					</tr>
				</thead>
			</table>
		</div>
