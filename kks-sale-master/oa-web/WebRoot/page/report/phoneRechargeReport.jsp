...
<html>
<head>
<script type="text/javascript" src="${ctx}/res/js/report/phoneRechargeReport.js?20170220"></script>
<script type="text/javascript" src='${ctx}/res/script/windowReset.js'></script>
<script type="text/javascript" src="${ctx}/res/js/my97datepicker/WdatePicker.js"></script>
</head>
<body style="margin: 0">
	<div class="easyui-layout" style="overflow: hidden; width: 100%; height: 100%" scroll="no" fit="true">
		<div region="center" id="dic-center" style="overflow: auto" title="手机卡充值报表">
			<div id="toolbar" style="padding: 10px 15px;">
				<div style="margin-bottom: 2px">
					<form action="" id="searchForm">
						<div>
							...
							<span>汇款方式：
								<select id="remittanceMethodSearch" class="easyui-combobox form-search" style="width: 100px;" editable="false" panelHeight="auto" >
							...
							<span>充值面额： <input type="text" class="easyui-validatebox form-search" validType="Amount" id="search_faceValue" style="width: 100px;"/></span>
						</div>
				...
				<div>
					...
					<table cellspacing="0" cellpadding="0">
						<tr>
							<td>
								<a href="javascript:;" class="easyui-linkbutton" iconCls="icon-addicon" plain="true" onclick="phone_recharge_addInfo();">增加</a>
							</td>
							<td>
								<div class="datagrid-btn-separator"></div>
							</td>
							<td>
								<a href="javascript:;" class="easyui-linkbutton" iconCls="icon-xgicon" plain="true" onclick="phone_recharge_updateInfo();">修改</a>
							</td>
							<td>
								<div class="datagrid-btn-separator"></div>
							</td>
							<td>
								<a href="javascript:;" class="easyui-linkbutton" iconCls="icon-delecticon" plain="true" onclick="phone_recharge_deleteInfo();">删除</a>
							</td>
							<td>
								<div class="datagrid-btn-separator"></div>
							</td>
			...
			<table id="DataGrid1" class="easyui-datagrid" singleSelect="true" sortable="true" rownumbers="false" pagination="true" fit="true" fitColumns="true" striped="true" pageSize="20" scrollbarSize="0" toolbar="#toolbar">
				<thead>
					<tr>
						<th checkbox="true" field="cardId"></th>
						<th field="rechargeDate" width="150" align="center">充值日期</th>
						<th field="cusName" width="150" align="center">客户名称</th>
						<th field="imei" width="100" align="center">IMEI号</th>
						<th field="phone" width="100" align="center">手机号</th>
						<th field="faceValue" width="100" align="center">充值面值(￥)</th>						
						<th field="monthNumber" width="60" align="center">月数</th>
						<th field="payable" width="120" align="center">收客户费用(￥)</th>
						<th field="payOther" width="120" align="center">需付给卡商(￥)</th>
						<th field="ratePrice" width="60" align="center">税费(￥)</th>
						...
						<th field="isMobileCharge" width="110" align="center">移动系统充值</th>
		...
		<div style="position: fixed;">
			<div id="updateWindow" class="easyui-window" title="更新手机卡充值信息" modal="true" closed="true" maximizable="false" minimizable="false" collapsible="false" style="visibility: hidden; width: 500px; height: 500px; padding: 5px;">
				<div class="easyui-layout" fit="true">
					<div region="center" border="false" style="padding: 10px; background: #fff; border: 1px solid #ccc; overflow: hidden">
						<form id="mform" action="">
							<table align="center">
								<tr style="display: none">
									<td>
										<input type="hidden" id="cardId" style="width: 250px;" />
									</td>
								</tr>
								<tr>
									<td>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;充值日期：</td>
								...
								<tr>
									<td>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;客户名称：</td>
									<td>
										<input type="text" id="cusName" style="width: 250px;" class="easyui-validatebox" />
									</td>
								</tr>
								<tr>
									<td>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;手&nbsp;机&nbsp;号：</td>
									<td>
										<input type="text" id="phone" style="width: 250px;" class="easyui-validatebox" validType="Mobile" required="true" missingMessage="请填写此字段" />
									</td>
								</tr>
								<tr>
									<td>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;IMEI：</td>
									<td>
										<input type="text" id="imei" style="width: 250px;" />
									</td>
								</tr>
								<tr>
									<td>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;充值面值：</td>
								...
								<tr>
									<td>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;状&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;态：</td>
									<td>
										<select id="orderStatus" style="width: 150px;" editable="false" panelHeight="auto">
						...
						<!-- 		<tr>
								...
								<tr>
									<td>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;汇款方式：</td>
									<td>
										<select id="remittanceMethod" class="easyui-combobox form-search" style="width: 150px;" editable="false" panelHeight="auto" >
											<option value="" selected="selected">全部</option>
											<option value="personPay">人工付款</option>
											<option value="aliPay">支付宝付款</option>
											<option value="weChatPay">微信付款</option>
								...
								<tr hidden="hidden">
									<td>&nbsp;&nbsp;&nbsp;&nbsp;是否打5折：</td>
									<td>
										<input type="radio" name="isDiscount" value="0" />是 <input type="radio" name="isDiscount" value="1" checked="checked" />否
									</td>
								</tr>
								<tr>
									<td>移动系统充值：</td>
									<td>
										<input type="radio" name="isMobileCharge" value="0" />是 <input type="radio" name="isMobileCharge" value="1" checked="checked" />否
									</td>
								</tr>
								<tr>
									<td>&nbsp;&nbsp;&nbsp;备&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;注：</td>
					...
					<div region="south" border="false" style="text-align: right; height: 30px; line-height: 30px;">
						<a id="recharge_save" class="easyui-linkbutton" iconCls="icon-ok" href="javascript:void(0)" onclick="phone_rechargeSave()">保存</a> 
