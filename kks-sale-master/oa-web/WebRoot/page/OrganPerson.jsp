  <%@ page language="java" import="java.util.*" pageEncoding="UTF-8"%>
   ...
   <div  zIndex=1000
    id="ManagerWindow" class="easyui-window" title="组织架构人员窗口" modal="true" closed="true" maximizable="false" minimizable="false" collapsible="false"
	    ...
	    <div id="Managertree"   style="position:absolute;height:400;width:230;overflow:auto; class="easyui-tree" animate="false" dnd="false"    > </div> 
	    </div>
		...
		<a id="treeAdd" class="easyui-linkbutton" iconCls="icon-ok" href="javascript:void(0)" onclick="ManagerWindowOnSelect()">确定</a>
