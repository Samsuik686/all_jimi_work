 ...
 * @version v1.0
 */
public interface PricePjMapper<T> extends BaseSqlMapper<T>{
	
	@SuppressWarnings("rawtypes")
	public Page queryListPage(@Param(PageInterceptor.PAGE_KEY) Page page, @Param("po") T po) throws  DataAccessException; 
	
	public int findCountForPricePj(@Param("repairNumber") String repairNumber,@Param("id") String id);
	
	public BigDecimal getPricePjCosts(@Param("repairNumber") String repairNumber);
	
	public void deleteInfo(@Param("ids") String... ids) throws DataAccessException;
	
	public List<PricePj> queryListByrepairNumber(@Param("repairNumber") String repairNumber) throws DataAccessException;
}