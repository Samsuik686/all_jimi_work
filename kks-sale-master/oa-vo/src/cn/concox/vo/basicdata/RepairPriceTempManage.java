...
/**
 * 维修报价表 数据库表名称：t_sale_repair_price_temp
 */
public class RepairPriceTempManage implements Serializable {
	...
	/**
	 * 字段名称： 数据使用状态 数据库字段信息 use_state varchar(10);
	 * 
	 */
	private String useState;

	/**
	 * 字段名称： 关联配件料 数据库字段信息 pjlDesc varchar(255);
	 * 
	 */
	...
	private BigDecimal pjlPrice;// 配件料价格

	private BigDecimal gzbjPrice;// 故障报价价格
	
	private String priceGroupDesc;//报价配件料组合
	
	private String priceGroupId;//组合id

	private String gzbjDesc;
	...
	public String getGzbjDesc() {
		return gzbjDesc;
	}

	public void setGzbjDesc(String gzbjDesc) {
		this.gzbjDesc = gzbjDesc;
	}
	...
	public void setGzbjId(String gzbjId) {
		this.gzbjId = gzbjId;
	}

	public BigDecimal getGzbjPrice() {
		return gzbjPrice;
	}

	public void setGzbjPrice(BigDecimal gzbjPrice) {
		this.gzbjPrice = gzbjPrice;
	}
