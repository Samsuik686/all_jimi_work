    ...
    <div v-if="isShow">
      <el-form :inline="true" :model="operationInfo" class="demo-form-inline">
        <el-form-item label="操作类型">
          <el-select v-model.trim="operationInfo.type"  value="" clearable>
        ...
        <el-form-item label="线号">
          <el-select v-model.trim="operationInfo.line"  value="" placeholder="选择线号" clearable>
            <el-option v-for="item in lines" :label="item.line" :value="item.id" :key="item.id"></el-option>
          </el-select>
        </el-form-item>
        <el-form-item label="工单号">
          <el-input v-model.trim="operationInfo.workOrderNo" placeholder="工单号" clearable></el-input>
        </el-form-item>
